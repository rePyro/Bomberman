...
public class CountUpgrade extends UpgradeBase
{
  // class code here;
  public CountUpgrade() {
    super("CountUpgrade");
  ...
  public void getUpgradeImage() {
    try {
      upgrade1 = ImageIO.read(new File("graphics/TileSprites/CountUpgrade-1.png"));
      upgrade2 = ImageIO.read(new File("graphics/TileSprites/CountUpgrade-2.png"));
      upgrade3 = ImageIO.read(new File("graphics/TileSprites/CountUpgrade-3.png"));
      upgrade4 = ImageIO.read(new File("graphics/TileSprites/CountUpgrade-4.png"));
      upgrade5 = ImageIO.read(new File("graphics/TileSprites/CountUpgrade-5.png"));
    } catch (IOException e) {
      e.printStackTrace(); // print the stack trace if there is an error loading the images
      System.out.println("Error loading CountUpgrade images!"); // print an error message
    }
  }
