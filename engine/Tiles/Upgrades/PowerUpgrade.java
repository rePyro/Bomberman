...
public class PowerUpgrade extends UpgradeBase
{
  // class code here;
  public PowerUpgrade() {
    super("PowerUpgrade");
  ...
  public void getUpgradeImage() {
    try {
      upgrade1 = ImageIO.read(new File("graphics/TileSprites/PowerUpgrade-1.png"));
      upgrade2 = ImageIO.read(new File("graphics/TileSprites/PowerUpgrade-2.png"));
      upgrade3 = ImageIO.read(new File("graphics/TileSprites/PowerUpgrade-3.png"));
      upgrade4 = ImageIO.read(new File("graphics/TileSprites/PowerUpgrade-4.png"));
      upgrade5 = ImageIO.read(new File("graphics/TileSprites/PowerUpgrade-5.png"));
    } catch (IOException e) {
      e.printStackTrace(); // print the stack trace if there is an error loading the images
      System.out.println("Error loading PowerUpgrade images!"); // print an error message
    }
  }
